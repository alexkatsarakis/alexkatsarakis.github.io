...
function onSettingsInventoryLoaded() {
  document
    .getElementById("inventory-window-background")
    .addEventListener("click", closeInventoryWindow);
  document
    .getElementById("inventory-window-head-close")
    .addEventListener("click", closeInventoryWindow);
  document.getElementById("inventory-window-head-title").innerHTML =
    tr.get("Live Assets");
