...
function onKeyboardInteraction(value) {
  ...
  function pressed() {
    if (isNaN(value)) keyboard.triggerEvent("PressedKey" + value);
    else keyboard.triggerEvent("PressedDigit" + value);
  }
  function unpressed() {
    if (isNaN(value)) keyboard.triggerEvent("UnpressedKey" + value);
    else keyboard.triggerEvent("UnpressedDigit" + value);
  }
