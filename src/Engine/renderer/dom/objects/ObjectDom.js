...
export default class ObjectDom extends Object {
  ...
  constructor(name, id, extra) {
    ...
    this.data.valueHandler.registerValue("width", {
      ...
      getValue: () => {
        return Number.parseFloat(this._width);
      },
    });
    ...
    this.data.valueHandler.registerValue("height", {
      ...
      getValue: () => {
        return Number.parseFloat(this._height);
      },
    });
  ...
  getMapCoords() {
    ...
    return [
      this._x / scene._aspectRatio - this._stage._x / scene._aspectRatio,
      this._y / scene._aspectRatio - this._stage._y / scene._aspectRatio,
    ];
  }
  ...
  removeDivFromScene() {
    if (this._state === "alive") scene.remove(this);
  }
